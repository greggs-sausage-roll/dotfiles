    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          vim.keymap.set('n', '<leader>ds', '<cmd>FzfLua lsp_document_symbols<CR>', { desc = '[D]ocument [S]ymbol' })
          --
          -- -- Fuzzy find all the symbols in your current workspace.
          -- --  Similar to document symbols, except searches over your entire project.
          vim.keymap.set('n', '<leader>ws', '<cmd>FzfLua lsp_workspace_symbols<CR>', { desc = '[W]orkspace [S]ymbol' })
          --
          vim.keymap.set('n', '<leader>tt', '<cmd>FzfLua treesitter<CR>', { desc = 'search through [T]reesi[t]ter' })
